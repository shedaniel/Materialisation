...
public class Modifiers {
    public static final Modifier HASTE = new HasteModifier();
    ...
    public static void fillEmpty() {
        Materialisation.MODIFIERS.stream().forEach(modifier -> {
    ...
    public static Optional<Modifier> getModifierByIngredient(ItemStack itemStack) {
