...
public class CottonResourcesMaterialsGetter {
    ...
    public static List<MaterialsPack> get() {
        ...
        put(materials, newMat("aluminum").wEnch(16).aIngr(fromTag(tryParse("c:aluminum_ingot")), 2).aIngr(fromTag(tryParse("c:aluminum_block")), 18).wAtta(2).wFull(100).wSpeed(5f).wDuraMulti(.85f).wSpeedMulti(1.3f).setBright(true).wColor(0xfff7b2d6).setToolDurability(300).setMiningLevel(1));
        put(materials, newMat("cobalt").wEnch(16).aIngr(fromTag(tryParse("c:cobalt_ingot")), 2).aIngr(fromTag(tryParse("c:cobalt_block")), 18).wAtta(4).wFull(200).wSpeed(12).wDuraMulti(1.1f).wSpeedMulti(1f).setBright(false).wColor(0xff172fd1).setToolDurability(800).setMiningLevel(3));
        put(materials, newMat("tin").wEnch(16).aIngr(fromTag(tryParse("c:tin_ingot")), 2).aIngr(fromTag(tryParse("c:tin_block")), 18).wAtta(2).wFull(100).wSpeed(5.1f).wDuraMulti(.9f).wSpeedMulti(1.1f).setBright(true).wColor(0xff63aeff).setToolDurability(290).setMiningLevel(1));
        put(materials, newMat("titanium").wEnch(16).aIngr(fromTag(tryParse("c:titanium_ingot")), 2).aIngr(fromTag(tryParse("c:titanium_block")), 18).wAtta(2.7f).wFull(150).wSpeed(7).wDuraMulti(.9f).wSpeedMulti(1).setBright(true).wColor(0xff777777).setToolDurability(600).setMiningLevel(2));
        put(materials, newMat("tungsten").wEnch(16).aIngr(fromTag(tryParse("c:tungsten_ingot")), 2).aIngr(fromTag(tryParse("c:tungsten_block")), 18).wAtta(3).wFull(175).wSpeed(8).wDuraMulti(1).wSpeedMulti(1).setBright(true).wColor(0xff2f2d44).setToolDurability(700).setMiningLevel(3));
        put(materials, newMat("platinum").wEnch(16).aIngr(fromTag(tryParse("c:platinum_ingot")), 2).aIngr(fromTag(tryParse("c:platinum_block")), 18).wAtta(2).wFull(50).wSpeed(10).wDuraMulti(.5f).wSpeedMulti(.7f).setBright(true).wColor(0xffffffff).setToolDurability(150).setMiningLevel(2));
        put(materials, newMat("palladium").wEnch(16).aIngr(fromTag(tryParse("c:palladium_ingot")), 2).aIngr(fromTag(tryParse("c:palladium_block")), 18).wAtta(3.5f).wFull(25).wSpeed(16).wDuraMulti(.4f).wSpeedMulti(.3f).setBright(true).wColor(0xffe1b4e8).setToolDurability(100).setMiningLevel(3));
        put(materials, newMat("osmium").wEnch(16).aIngr(fromTag(tryParse("c:osmium_ingot")), 2).aIngr(fromTag(tryParse("c:osmium_block")), 18).wAtta(2).wFull(125).wSpeed(4.25f).wDuraMulti(1.1f).wSpeedMulti(1).setBright(true).wColor(0xffc2dfed).setToolDurability(500).setMiningLevel(2));
        put(materials, newMat("iridium").wEnch(16).aIngr(fromTag(tryParse("c:iridium_ingot")), 2).aIngr(fromTag(tryParse("c:iridium_block")), 18).wAtta(5).wFull(150).wSpeed(6.5f).wDuraMulti(.9f).wSpeedMulti(1.2f).setBright(true).wColor(0xffb0f2b7).setToolDurability(600).setMiningLevel(3));
