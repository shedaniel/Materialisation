...
public class MaterialisingTableScreen extends ContainerScreen<MaterialisingTableContainer> implements ContainerListener {
    ...
    protected void drawBackground(MatrixStack matrixStack, float v, int i, int i1) {
        ...
        int int_3 = x;
        int int_4 = y;
        this.drawTexture(matrixStack, int_3, int_4, 0, 0, this.containerWidth, this.containerHeight);
        this.drawTexture(matrixStack, int_3 + 34, int_4 + 20, 0, this.containerHeight + (this.container.getSlot(0).hasStack() ? 0 : 16), 110, 16);
        if ((this.container.getSlot(0).hasStack() || this.container.getSlot(1).hasStack()) && !this.container.getSlot(2).hasStack()) {
            this.drawTexture(matrixStack, int_3 + 99, int_4 + 45, this.containerWidth, 0, 28, 21);
        }
    }
