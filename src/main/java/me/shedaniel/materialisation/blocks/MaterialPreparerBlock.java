...
public class MaterialPreparerBlock extends HorizontalFacingBlock implements NamedScreenHandlerFactory {
    ...
    public MaterialPreparerBlock() {
        super(FabricBlockSettings.of(new FabricMaterialBuilder(Material.WOOD.getColor()).burnable().build()).strength(3, 3).drops(new Identifier(ModReference.MOD_ID, "blocks/material_preparer")).sounds(BlockSoundGroup.WOOD));
