...
public class MaterialisationREIPlugin implements REIPluginV0 {
    ...
    public static final Identifier PLUGIN = new Identifier(Materialisation.MOD_ID, "rei_plugin");
    public static final Identifier MATERIAL_PREPARER = new Identifier(Materialisation.MOD_ID, "material_preparer");
    public static final Identifier MATERIALISING_TABLE = new Identifier(Materialisation.MOD_ID, "materialising_table");
    ...
    public void registerEntries(EntryRegistry entryRegistry) {
        ...
        entryRegistry.getModifiableEntryList().removeIf(entry -> entry.getEntryType() == Entry.Type.ITEM && entry.getItemStack().getItem() instanceof PartItem && !entry.getItemStack().getOrCreateTag().containsKey("mt_name_key") && !entry.getItemStack().getOrCreateTag().containsKey("mt_0_material") && !entry.getItemStack().getOrCreateTag().containsKey("mt_material"));
    }
