...
public class ColoredItem extends Item {
    ...
    public ColoredItem(Settings item$Settings_1) {
        ...
        addProperty(new Identifier(MaterialisedReference.MOD_ID, "bright"), (itemStack, world, livingEntity) -> {
    ...
    public static Optional<String> getItemTranslationKey(ItemStack stack) {
        if (stack.getOrCreateTag().containsKey("mt_name_key")) {
            ...
            if (stack.getItem() == MaterialisedTools.HANDLE)
                return Optional.ofNullable(I18n.translate("item.materialisedtools.materialised_handle", I18n.translate("material.materialisedtools." + stack.getOrCreateTag().getString("mt_material"))));
            if (stack.getItem() == MaterialisedTools.PICKAXE_HEAD)
                return Optional.ofNullable(I18n.translate("item.materialisedtools.materialised_pickaxe_head", I18n.translate("material.materialisedtools." + stack.getOrCreateTag().getString("mt_material"))));
        }
