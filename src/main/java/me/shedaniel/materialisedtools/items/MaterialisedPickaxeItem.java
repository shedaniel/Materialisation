...
public class MaterialisedPickaxeItem extends PickaxeItem {
    ...
    public void buildTooltip(ItemStack stack, World world_1, List<Component> list_1, TooltipContext tooltipContext_1) {
        ...
        list_1.add(new TranslatableComponent("text.materialisedtools.max_durability", maxDurability));
        if (toolDurability > 0)
            list_1.add(new TranslatableComponent("text.materialisedtools.durability", toolDurability, MaterialisedToolUtils.TWO_DECIMAL_FORMATTER.format(toolDurability / (float) maxDurability * 100)));
        else
            list_1.add(new TranslatableComponent("text.materialisedtools.broken"));
        list_1.add(new TranslatableComponent("text.materialisedtools.breaking_speed", MaterialisedToolUtils.TWO_DECIMAL_FORMATTER.format(MaterialisedToolUtils.getToolBreakingSpeed(stack))));
        list_1.add(new TranslatableComponent("text.materialisedtools.mining_level", MaterialisedToolUtils.getToolMiningLevel(stack)));
    }
